export class Result_Male implements common {
    ...
    CalculateMethod() {
        ...
        if (isNaN(this.bmi.height) || this.bmi.height == '') {
            ...
            this.GJHamwi_Formula = (48 + (2.7 * ((this.bmi.height - 152.4) * 0.393701)));
            this.BJDevine_Formula = (50 + (2.3 * ((this.bmi.height - 152.4) * 0.393701)));
            this.JDRobinson_Formula = (52 + (1.7 * ((this.bmi.height - 152.4) * 0.393701)));
            this.DRMiller_Formula = (56.2 + (1.36 * ((this.bmi.height - 152.4) * 0.393701)));
            this.bmi2 = ((this.bmi.height - 100 + (this.bmi.age * 0.1)) * 0.9);
            this.ShowResult();
        }
    }
